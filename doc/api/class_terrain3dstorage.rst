...
.. XML source: https://github.com/godotengine/godot/tree/master/Terrain3D_RepoClone/doc/classes/Terrain3DStorage.xml.
...
.. table::
   ...
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | godot.Error                            | :ref:`add_region<class_Terrain3DStorage_method_add_region>`\ (\ global_position\: ``Vector3``, images\: :ref:`Array<class_Array>`\[``Image``\] = [], update\: ``bool`` = true\ )                                              |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | godot.Error                            | :ref:`export_image<class_Terrain3DStorage_method_export_image>`\ (\ file_name\: ``String``, map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )                                                                       |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Color``                              | :ref:`get_color<class_Terrain3DStorage_method_get_color>`\ (\ global_position\: ``Vector3``\ )                                                                                                                                |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``                                | :ref:`get_control<class_Terrain3DStorage_method_get_control>`\ (\ global_position\: ``Vector3``\ )                                                                                                                            |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``float``                              | :ref:`get_height<class_Terrain3DStorage_method_get_height>`\ (\ global_position\: ``Vector3``\ )                                                                                                                              |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Image``                              | :ref:`get_map_region<class_Terrain3DStorage_method_get_map_region>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, region_index\: ``int``\ )                                                                   |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Array<class_Array>`\[``Image``\] | :ref:`get_maps<class_Terrain3DStorage_method_get_maps>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )                                                                                                       |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Array<class_Array>`\[``Image``\] | :ref:`get_maps_copy<class_Terrain3DStorage_method_get_maps_copy>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )                                                                                             |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Vector3``                            | :ref:`get_mesh_vertex<class_Terrain3DStorage_method_get_mesh_vertex>`\ (\ lod\: ``int``, filter\: :ref:`HeightFilter<enum_Terrain3DStorage_HeightFilter>`, global_position\: ``Vector3``\ )                                   |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Vector3``                            | :ref:`get_normal<class_Terrain3DStorage_method_get_normal>`\ (\ global_position\: ``Vector3``\ )                                                                                                                              |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Color``                              | :ref:`get_pixel<class_Terrain3DStorage_method_get_pixel>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, global_position\: ``Vector3``\ )                                                                      |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``                                | :ref:`get_region_count<class_Terrain3DStorage_method_get_region_count>`\ (\ )                                                                                                                                                 |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``                                | :ref:`get_region_index<class_Terrain3DStorage_method_get_region_index>`\ (\ global_position\: ``Vector3``\ )                                                                                                                  |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Vector2i``                           | :ref:`get_region_offset<class_Terrain3DStorage_method_get_region_offset>`\ (\ global_position\: ``Vector3``\ )                                                                                                                |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``float``                              | :ref:`get_roughness<class_Terrain3DStorage_method_get_roughness>`\ (\ global_position\: ``Vector3``\ )                                                                                                                        |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Vector3``                            | :ref:`get_texture_id<class_Terrain3DStorage_method_get_texture_id>`\ (\ global_position\: ``Vector3``\ )                                                                                                                      |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``bool``                               | :ref:`has_region<class_Terrain3DStorage_method_has_region>`\ (\ global_position\: ``Vector3``\ )                                                                                                                              |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`import_images<class_Terrain3DStorage_method_import_images>`\ (\ images\: :ref:`Array<class_Array>`\[``Image``\], global_position\: ``Vector3`` = Vector3(0, 0, 0), offset\: ``float`` = 0.0, scale\: ``float`` = 1.0\ ) |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Image``                              | :ref:`layered_to_image<class_Terrain3DStorage_method_layered_to_image>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )                                                                                       |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``Image``                              | :ref:`load_image<class_Terrain3DStorage_method_load_image>`\ (\ file_name\: ``String``, cache_mode\: ``int`` = 0, r16_height_range\: ``Vector2`` = Vector2(0, 255), r16_size\: ``Vector2i`` = Vector2i(0, 0)\ ) |static|      |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`remove_region<class_Terrain3DStorage_method_remove_region>`\ (\ global_position\: ``Vector3``, update\: ``bool`` = true\ )                                                                                              |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`save<class_Terrain3DStorage_method_save>`\ (\ )                                                                                                                                                                         |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_color<class_Terrain3DStorage_method_set_color>`\ (\ global_position\: ``Vector3``, color\: ``Color``\ )                                                                                                             |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_control<class_Terrain3DStorage_method_set_control>`\ (\ global_position\: ``Vector3``, control\: ``int``\ )                                                                                                         |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_height<class_Terrain3DStorage_method_set_height>`\ (\ global_position\: ``Vector3``, height\: ``float``\ )                                                                                                          |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_map_region<class_Terrain3DStorage_method_set_map_region>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, region_index\: ``int``, image\: ``Image``\ )                                                |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_pixel<class_Terrain3DStorage_method_set_pixel>`\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, global_position\: ``Vector3``, pixel\: ``Color``\ )                                                   |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                 | :ref:`set_roughness<class_Terrain3DStorage_method_set_roughness>`\ (\ global_position\: ``Vector3``, roughness\: ``float``\ )                                                                                                 |
   +----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
:ref:`Array<class_Array>`\[``Image``\] **color_maps** = ``[]``
...
:ref:`Array<class_Array>`\[``Image``\] **control_maps** = ``[]``
...
:ref:`Array<class_Array>`\[``Image``\] **height_maps** = ``[]``
...
:ref:`Array<class_Array>`\[``Vector2i``\] **region_offsets** = ``[]``
...
godot.Error **add_region**\ (\ global_position\: ``Vector3``, images\: :ref:`Array<class_Array>`\[``Image``\] = [], update\: ``bool`` = true\ )
...
godot.Error **export_image**\ (\ file_name\: ``String``, map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )
...
``Image`` **get_map_region**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, region_index\: ``int``\ )
...
:ref:`Array<class_Array>`\[``Image``\] **get_maps**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )
...
:ref:`Array<class_Array>`\[``Image``\] **get_maps_copy**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )
...
``Vector3`` **get_mesh_vertex**\ (\ lod\: ``int``, filter\: :ref:`HeightFilter<enum_Terrain3DStorage_HeightFilter>`, global_position\: ``Vector3``\ )
...
``Color`` **get_pixel**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, global_position\: ``Vector3``\ )
...
|void| **import_images**\ (\ images\: :ref:`Array<class_Array>`\[``Image``\], global_position\: ``Vector3`` = Vector3(0, 0, 0), offset\: ``float`` = 0.0, scale\: ``float`` = 1.0\ )
...
``Image`` **layered_to_image**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`\ )
...
|void| **set_map_region**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, region_index\: ``int``, image\: ``Image``\ )
...
|void| **set_maps**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, maps\: :ref:`Array<class_Array>`\[``Image``\]\ )
...
|void| **set_pixel**\ (\ map_type\: :ref:`MapType<enum_Terrain3DStorage_MapType>`, global_position\: ``Vector3``, pixel\: ``Color``\ )
